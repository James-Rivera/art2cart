            ...
            <div class="order-details-container">
                ...
                <div class="order-details-right">
                    <div class="order-summary-section">
                        ...
                        <button class="continue-shopping-btn" onclick="window.location.href='/Art2Cart/catalogue.php'">Continue Shopping</button>
                        
                        <div class="help-text">
                            Need help? <a href="/Art2Cart/contact" class="support-link">Contact Support</a>
                        </div>
                    </div>
                </div>
            </div>
